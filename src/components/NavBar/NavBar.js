      ...
      return  ( 
        ...
        <div className='d-flex align-items-center justify-content-between p-2 bg-light'> 
             ...
             <ul className='d-flex align-item-center' style={{listStyle:'none'}}>
                 ...
                 <NavLink to={'/category/:hombre'} className="dropdown-item" href="#">Hombre</NavLink>		
                 <NavLink to={'/category/:mujer'} className="dropdown-item" href="#">Mujer</NavLink>		
                 <NavLink to={'/category/:unisex'} className="dropdown-item" href="#">Unisex</NavLink>
                 </div>
                 </div>
                 </NavLink>
